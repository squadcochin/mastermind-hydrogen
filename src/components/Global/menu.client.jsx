...
import { CartDetails } from '../DynamicProduct/CartDetails.client';
            ...
            <div  className="sm:pl-12 pl-3">
               <div  className="top_bar flex items-center  sm:justify-between justify-start" >
                     ...
                     <div  className="main_nav" id="main_nav">
                        <div  className="nav1 ">
                           <ul  className="menu align_left sm:flex-row flex flex-col">
                              <li className="px-3.5">
                              <nav className="font-bold uppercase text-lg text-white">
                                    {(menu.items).map((item) => (
                                       <Link to={item.to} className="pl-3">
                                          {item.title}
                                       </Link>
                                    ))}
                           </nav>
                  ...
                  <div  className="basis-2/5 items-center hidden sm:flex"> 
                        ...
                        <button
                           onClick={openDrawer}
                           className="cart-container relative"
                        >
                           <IconBag />
