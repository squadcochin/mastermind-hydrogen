...
declare type SelectableQuestion<TName extends string> = BaseQuestion<TName> & {
    type: 'select' | 'autocomplete';
    choices: QuestionChoiceType[];
};
export declare type Question<TName extends string = string> = TextQuestion<TName> | SelectableQuestion<TName> | PasswordQuestion<TName>;
